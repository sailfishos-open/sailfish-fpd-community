...
void AndroidFP::acquired_cb(uint64_t, UHardwareBiometryFingerprintAcquiredInfo info, int32_t vendorCode, void *context)
{
    qDebug() << Q_FUNC_INFO << info << "vendorCode" << vendorCode;
